...
<div class="box">
    <form action="${ctx}/prize/edit.${urlExt}" method="post" id="dataForm">
        <input type="hidden" name="data.id" value='${data["id"]}'/>
        <table class="PopUpTableBorder" width="99%">
            <tr>
                <td class="PopUpTableTitle">等级：</td>
                <td>${type!}</td>
                <div id="data_typeTip"/>
                </td>
                <td align="left">
            ...
            <tr>
                <td class="PopUpTableTitle">名称：</td>
            ...
            <tr>
                ...
                <td><input id="data_note" name="data.note" style="width: 97%" class="PopUpInput"
                           value="${data.note?default("")}"/></td>
                <td width="220px">
                    <div id="data_noteTip"/>
                </td>
            </tr>
            ...
            <tr>
                <td class="PopUpTableTitle">照片：</td>
                <td>
            ...
            <tr>
                <td class="PopUpTableTitle">原图预览：
                </td>
                <td><img
                        src="${photo_path!''}" alt="" height="80"/></td>
                <td align="left">
                </td>
            </tr>
        </table>
