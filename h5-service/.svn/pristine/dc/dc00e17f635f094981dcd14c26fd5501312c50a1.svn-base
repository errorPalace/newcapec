...
<div class="box">
    <table id="addData" border="0" cellspacing="0" cellpadding="0" class="PopUpTableBorder">
        <tr>
            <td width="100px" class="PopUpTableTitle">举办活动：</td>
            <td width="200px">${sonActivityId?default("")}</td>
            <td width="100px" class="PopUpTableTitle">奖品：</td>
            <td width="200px">${prizeId!}</td>
        </tr>
        <tr>
            <td class="PopUpTableTitle">预计发奖 ：</td>
            <td>${data.allotCount!}</td>
            <td class="PopUpTableTitle">上期叠加：</td>
            <td>${data.surplusCount!}</td>
        </tr>
        <tr>
            <td width="80px" class="PopUpTableTitle">中奖数量：</td>
            <td colspan="3">${data.inCount!}</td>
        </tr>
        <tr>
