...
<!--[if IE 6]><script type="text/javascript" src="${wctx}/pub/style/themes/transport/js/iepng.js" ></script><![endif]-->
<link href="${wctx}/pub/style/themes/transport/css/login_style.css" rel="stylesheet" type="text/css"/>
                        ...
                        <div id="company"></div>
                         <form id="login_form" name="login_form" action="j_spring_security_check" method="post">
                            ...
                            <div class="passwordBox">
                                ...
                                <input tabindex="2" id="t_password" type="password" class="password" maxlength="30"/>
                            </div>
                            
<div id="jcaptchaElement" class="checkcodeBox">
      <div class="clearfix yzm_bg">
      <input tabindex="3" id="j_captcha" name="j_captcha" type="text" maxlength="10"/>
      <a href="javascript:;"><img id="captchaImg" width="100" height="32" class="checkcode" border="0" /></a>
      </div>
      <p class="clearfix">按右图填写，不区分大小写</p>
      <img id="rightImage" class="abc">
</div>
...
<div class="footerBox">
    <div class="footer clearfix">
        <p class="copy">郑州新开普电子股份有限公司&nbsp;版权所有&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;推荐使用IE8，IE9，火狐，&nbsp;&nbsp;同时支持IE6，Chrome &nbsp;&nbsp建议1024*768以上分辨率访问本系统</p>
    </div>
</div>
    </div>
 </div>
