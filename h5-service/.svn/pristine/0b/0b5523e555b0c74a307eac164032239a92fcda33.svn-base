...
public class Pboc3desmac {
	...
	protected static transient final Logger log = LoggerFactory.getLogger(Pboc3desmac.class);

	public static String sign(Map<String, String> params, String key) {

		return sign(params, key, "0000000000000000", true);
	...
	public static String sign(Map<String, String> params, String key, boolean isOld) {
		return sign(params, key, "0000000000000000", isOld);
	}
