    ...
    <script language="javascript">
        $(document).ready(function () {
            grid = new SimpleGrid({
                ...
                columns: [
                    ...
                    {name: "programIds", title: "所投节目", width: "80px"},
            ...
            //查看
            $("#programVoteLog_view").click(function () {
                var checkboxkeys = [];
                ...
                if (checkboxkeys.length == 0) {
                    ...
                    thickbox.attr("href", "${ctx}/programVoteLog/view.${urlExt}?dataid=" + checkboxkeys.toString() + "&width=600&height=200");
                    thickbox.click();
                }
            });
        ...
        <#list Session["_curentMenuFunctions"] as funcID>
            ...
            function changeToolbarState() {
                ...
                $("#programVoteLog_view").attr("disabled", !(hasSelected && (!selectedMany)));
            }
...
<div class="main" id="main">
    ...
    <div class="toolbar">
        <li><input type="button" id="programVoteLog_view" disabled="disabled" class="view" style="display: none"
                   value="查看"/></li>
    </div>
</div>
...
<div id="queryD" style="width:100%;">
    <div class="query">
        <form id="searForm" method="post" action="${ctx}/programVoteLog/list.${urlExt}">
