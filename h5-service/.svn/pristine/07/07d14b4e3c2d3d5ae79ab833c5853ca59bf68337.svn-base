...
<div class="box">
    <form action="${ctx}/activityPrizeCfg/edit.${urlExt}" method="post" id="dataForm">
        ...
        <table class="PopUpTableBorder" width="99%">
            ...
            <tr>
                ...
                <td>${prizeType?default("")}[${prizeId?default("")}]</td>
                <td width="220px">
            ...
            <tr>
                ...
                <td>${data.winCount?default("")}</td>
                <td>
                    <div id="data_winCountTip"/>
                </td>
            </tr>
            <tr>
                <td class="PopUpTableTitle">已分配数量：</td>
                <td>${data.allotCount?default("")}</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input id="data_count" name="data.count" style="width:97%;height:25px;" class="PopUpInput"value="${data.count?default("")}"/>
                </td>
                <td>
