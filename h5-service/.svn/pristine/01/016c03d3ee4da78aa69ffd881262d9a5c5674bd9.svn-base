...
<div class="box">
    <form action="${ctx}/sonActivityPrizeCfg/add.${urlExt}" method="post" id="dataForm">
        <table border="0" cellspacing="0" cellpadding="0" class="PopUpTableBorder" width="99%">
            <tr>
                ...
                <td><select id="data_sonActivityId" name="data.sonActivityId" style="width:95%" class="PopUpInput">
            ...
            <tr>
                ...
                <td>
                    <input id="data_allotCount" name="data.allotCount" style="width:97%;height: 25px;" class="PopUpInput"/>
                </td>
                <td>
