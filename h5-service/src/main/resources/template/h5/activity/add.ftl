...
<div class="box">
    <form action="${ctx}/activity/add.${urlExt}" method="post" id="dataForm">
        <table border="0" cellspacing="0" cellpadding="0" class="PopUpTableBorder" width="99%">
            <tr>
                <td class="PopUpTableTitle"><span style="color:red">*</span>活动名称：</td>
            ...
            <tr>
                <td class="PopUpTableTitle"><span style="color:red">*</span>描述：</td>
                <td>
