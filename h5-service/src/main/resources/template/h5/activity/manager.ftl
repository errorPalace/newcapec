...
<script language="javascript" src="${wctx}/pub/script/jquery/jquery.form.js"></script>
		<script language="javascript">
			$(document).ready(function(){
				...
				$("#activity_add").click(function(){
					...
					thickbox.attr("href","${ctx}/activity/enterAdd.${urlExt}?width=650&height=300");
					thickbox.click();
				});
				//查看
	...
	<div class="main" id="main">
		...
		<div class="toolbar">
			<li><input type="button" id="activity_view" disabled="disabled" class="view" style="display: none" value="查看"/></li>
			<li><input type="button" id="activity_add" class="add" style="display: none" value="增加"/></li>
	      	<li><input type="button" id="activity_edit" disabled="disabled" class="edit" style="display: none" value="编辑"/></li>
	      	<li><input type="button" id="activity_del" disabled="disabled" class="del" style="display: none" value="删除"/></li>
            <li><input type="button" id="activity_openuse" disabled="disabled" class="edit" style="display: none" value="开放抽奖"/></li>
            <li><input type="button" id="activity_closeuse" disabled="disabled" class="edit" style="display: none" value="关闭抽奖"/></li>
  		</div>
	</div>
	
    <div id="queryD" style="width:100%;">
				<div class="query">
					<form id="searForm" method="post" action="${ctx}/activity/list.${urlExt}">
