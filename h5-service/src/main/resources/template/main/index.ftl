...
<link href="${wctx}/pub/style/themes/campus/css/main_style.css" rel="stylesheet" type="text/css" />
...
//<!--
	...
	function reinitIframe() {
		...
		try {
			...
			$("#left-side").css("height", $(".iframe-div").css("height"));
			
			$("#left-side").css("overflow-x", "hidden");
	...
	<div id="header">
		...
		<div class="header-menu">
			<ul>
				...
				<li><a href="desktop.action" target="frame_content"><img src="${wctx}/pub/style/themes/campus/css/main_img/home.png" border="0" /><span>返回首页</span>
				</a>
				</li>
				<#if isAdmin>
					<li><a id="showAdjustMenuItemWindow" href="javascript:;"><img src="${wctx}/pub/style/themes/campus/css/main_img/syzn_t.png" border="0" /><span>菜单调整</span></a></li>
				</#if>
													
				<li><a href="javascript:;" id="editPassword"><img src="${wctx}/pub/style/themes/campus/css/main_img/pws.png" border="0" /><span>修改密码</span></a></li>
				<li><a href="javascript:;" id="signout-link"><img src="${wctx}/pub/style/themes/campus/css/main_img/aqtc_t.png" border="0" /><span>安全退出</span></a></li>
			</ul>
		</div>
	</div>
	<div id="main-content">
			...
			<div id="navbar">
				<div id="firstpane" class="menu-list">
					...
					<p class="menu-head current">
						<a href="javascript:;"><img src="${wctx}/pub/style/themes/campus/css/main_img/menu_person.png" border="0" />${menuItem.title}</a>
					</p>
					<#else>
					<p class="menu-head">
						<a href="javascript:;"><img src="${wctx}/pub/style/themes/campus/css/main_img/menu_total.png" border="0" />${menuItem.title}</a>
					</p>
					...
					<p class="menu-head">
						<a href="javascript:openMenu('${menuItem.url}');"><img src="${wctx}/pub/style/themes/campus/css/main_img/menu_total.png" border="0" />${menuItem.title}</a>
					</p>
					</#if></#list></#if>
